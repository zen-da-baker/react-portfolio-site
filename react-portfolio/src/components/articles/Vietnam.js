...
export default function Vietnam() {
    ...
    <article className="content">
        ...
        <div className="center-div">
            <figcaption><a href="../index.html">Donovan Frazier</a> | Oct 18, 2022 | Updated Feb 25, 2023</figcaption>
        </div>

        <div className="center-div">
            <p>For this historical analysis, I will be comparing Minh Mạng the second emperor of the 
            ...
            <p>Minh Mạng as mentioned before was the second emperor in the Nguyễn dynasty and was 
                ...
                was a more expansive empire than its predecessor.</p>

                
            <p>Nguyễn Thị Bình got her start organizing student protests in the 1950s in Sài Gòn against 
            ...
            <p>Both Minh Mạng and Nguyễn Thị Bình focused on consolidating and centralizing 
                ...
                Second Indochina War was ending soon.</p>

            <p>Both figures did consolidate Vietnam into a singular state but in different ways and with 
                ...
                Nguyễn Thị Bình among other leaders resulted in a more effective nationalist policies.</p>
